...
pub use service::{
    DocFreshness, DocFrontmatter, DriftIssue, DriftReport, EmbedService, apply_doc_content,
    apply_doc_frontmatter, content_hash, cosine, doc_freshness, parse_doc_meta, parse_frontmatter,
